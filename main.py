...
def stockInput():
    ...
    if request.method == 'POST':
        ...
        if submitState =='1':
            ...
            #print("returnData1 is" + str(returnData1) + str(type(returnData1)))
            #print("returnData2 is" + str(returnData2) + str(type(returnData2)))
            ...
            #----------------FOR DRAWDOWN CHARTS -------------------------------------
            stock1_drawdowns = drawdownChart(returnData1[0]['Expected Return'])
